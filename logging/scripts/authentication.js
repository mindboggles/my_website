async function authenticate() {
	...
	try {
		...
		document.cookie = "Login_ID=" + text + "; expires=" + new Date(Date.now() + 60000 * 1440).toUTCString() + "; SameSite=Lax; path=/logging; secure";
...
async function deauthenticate() {
	document.getElementById("logout_section").hidden = true;
	...
	try {
		...
		document.cookie = "Login_ID=; expires=Thu, 01 Jan 1970 00:00:00 GMT; Samesite=Lax; path=/logging;";
